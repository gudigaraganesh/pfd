...
IMPLEMENT_DYNAMIC_CLASS(wxTableInfo, wxGrid)


wxTableInfo::wxTableInfo(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size ,const wxString & sz_title,wxColour & clr,wxColour & foreclr,wxColour & lclr)
...
wxTableInfo::~wxTableInfo()
{
}
void wxTableInfo::SetLastGridColSize(int presentwidth)
{
int newwidth;
int addwidth=0;
