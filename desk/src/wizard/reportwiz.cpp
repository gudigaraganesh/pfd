 ...
 ***************************************************************************/
#include <reportwiz.h>
BEGIN_EVENT_TABLE(wxReportWizard, wxWizardPageSimple)
    EVT_WIZARD_PAGE_CHANGING(-1, wxReportWizard::OnWizardPageChanging)
        EVT_WIZARD_CANCEL(-1, wxReportWizard::OnWizardCancel)
END_EVENT_TABLE()
    ...
    wxReportWizard::wxReportWizard(wxWizard *parent) : wxWizardPageSimple(parent)
    {
        wxString choices[4];
        choices[0] = _T("Serial");
    ...
    void wxReportWizard::OnWizardCancel(wxWizardEvent& event)
    {
    ...
    void wxReportWizard::OnWizardPageChanging(wxWizardEvent& event)
    {
...
void wxReportWizard::AddSerialPage(wxSerialWizard *spage)
{
serpage=spage;
}
void wxReportWizard::AddUSBPage(wxUSBWizard *spage)
{
upage=spage;
}
void wxReportWizard::AddNetworkPage(wxNetWizard *spage)
{
npage=spage;
}
void wxReportWizard::AddBluetoothPage(wxBluetoothWizard *spage)
{
bpage=spage;
}
     //wxWizardPage *wxReportWizard::GetPrev() const 
	//{ 
	//return m_prev; 
	//}
     wxWizardPage *wxReportWizard::GetNext() const
    {
