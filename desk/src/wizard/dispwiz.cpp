 ...
 ***************************************************************************/
#include <dispwiz.h>
BEGIN_EVENT_TABLE(wxDispWizard, wxWizardPageSimple)
    EVT_WIZARD_PAGE_CHANGING(-1, wxDispWizard::OnWizardPageChanging)
        EVT_WIZARD_CANCEL(-1, wxDispWizard::OnWizardCancel)
END_EVENT_TABLE()
    ...
    wxDispWizard::wxDispWizard(wxWizard *parent) : wxWizardPageSimple(parent)
    {
        wxString choices[4];
        choices[0] = _T("Serial");
    ...
    void wxDispWizard::OnWizardCancel(wxWizardEvent& event)
    {
    ...
    void wxDispWizard::OnWizardPageChanging(wxWizardEvent& event)
    {
...
void wxDispWizard::AddSerialPage(wxSerialWizard *spage)
{
serpage=spage;
}
void wxDispWizard::AddUSBPage(wxUSBWizard *spage)
{
upage=spage;
}
void wxDispWizard::AddNetworkPage(wxNetWizard *spage)
{
npage=spage;
}
void wxDispWizard::AddBluetoothPage(wxBluetoothWizard *spage)
{
bpage=spage;
}
     //wxWizardPage *wxDispWizard::GetPrev() const 
	//{ 
	//return m_prev; 
	//}
     wxWizardPage *wxDispWizard::GetNext() const
    {
