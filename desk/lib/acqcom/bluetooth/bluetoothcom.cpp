...
wxBluetoothCom::wxBluetoothCom(char *serDev, bool bDevOpen)
...
int wxBluetoothCom::OpenDevice(char *serDev, int mode)
{
	int fd = -1;
...
int wxBluetoothCom::CloseDevice()
{
	int ret = -1;
...
int wxBluetoothCom::ReadDevice(char *serBuf, int endMark, int cmd)
{
#if !defined(__WXMSW__)
	int n = 0;
	int offset = 0;
...
int wxBluetoothCom::WriteDevice(char *serBuf, int endMark, bool bFile)
{
#if !defined(__WXMSW__)
	int n = 0;
	int offset = 0;
...
int wxBluetoothCom::ConfigureDevice()
{
	unsigned long baudR;
...
int wxBluetoothCom::Rselect(int fd, struct timeval *timeout)
{
#if !defined(__WXMSW__)
	fd_set readfds;
...
int wxBluetoothCom::Wselect(int fd, struct timeval *timeout)
{
#if !defined(__WXMSW__)
	fd_set writefds;
...
__u8 wxBluetoothCom::GetDataBit()
{
	return dataBit;
}

__u8 wxBluetoothCom::GetStopBit()
{
	return stopBit;
}

__u8 wxBluetoothCom::GetParityBit()
{
	return parityBit;
}

__u8 wxBluetoothCom::GetFlowControl()
{
	return flowControl;
}

__u64 wxBluetoothCom::GetBaudRate()
{
	return baudRate;
}

void wxBluetoothCom::SetDataBit(__u8 dataB)
{
	dataBit = dataB;
}

void wxBluetoothCom::SetParityBit(__u8 parityB)
{
	parityBit = parityB;
}

void wxBluetoothCom::SetStopBit(__u8 stopB)
{
	stopBit = stopB;
}

void wxBluetoothCom::SetFlowControl(__u8 flowC)
{
	flowControl = flowC;
}

void wxBluetoothCom::SetBaudRate(__u64 baudB)
{
	baudRate = baudB;
}

#ifdef __WXMSW__
HANDLE wxBluetoothCom::GetDevHandle()
{
	return h_Dev;
}

void wxBluetoothCom::SetHandle(Handle hnd)
{
	h_Dev = hnd;
}
#endif
int wxBluetoothCom::SetSerialSpeed(int fd, int speed)
{
#ifdef __WXMSW__
	BOOL fRetVal;
	DCB dcb;
...
int wxBluetoothCom::SetSerialDataBit(int fd, int databits)
{
#ifdef __WXMSW__
	BOOL fRetVal;
	DCB dcb;
...
int wxBluetoothCom::SetSerialParityBit(int fd, int paritybits)
{
#ifdef __WXMSW__
	BOOL fRetVal;
	DCB dcb;
...
int wxBluetoothCom::SetSerialStopBit(int fd, int stopbits)
{
#ifdef __WXMSW__
	BOOL fRetVal;
	DCB dcb;
...
int wxBluetoothCom::SetSerialFlowControl(int fd, int flowctl)
{
#ifdef __WXMSW__
	BOOL fRetVal;
	DCB dcb;
...
int wxBluetoothCom::SetSerialDTRRTS(int fd, bool rts, bool dtr)
{
#ifdef __WXMSW__
	BOOL fRetVal;
	DCB dcb;
...
int wxBluetoothCom::MapSpeed(int speed)
{
#if !defined(__WXMSW__)
	switch (speed) {
	case BAUD_4800:
...
int wxBluetoothCom::MapDataBit(int databits)
{
#if !defined(__WXMSW__)
	switch (databits) {
	case DATABIT_5:
...
int wxBluetoothCom::MapParityBit(int paritybits)
{
#ifdef __WXMSW__
	switch (paritybits) {
	case PAR_EVEN:
...
int wxBluetoothCom::MapStopBit(int stopbits)
{
#ifdef __WXMSW__
	switch (stopbits) {
	case STOP_1:
