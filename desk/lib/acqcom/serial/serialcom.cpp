...
wxSerialCom::wxSerialCom(char *serDev, bool bDevOpen)
...
int wxSerialCom::OpenDevice(char *serDev, int mode)
{
	int fd = -1;
...
int wxSerialCom::ReadDevice(char *serBuf, int endMark, int cmd)
{
#if !defined(__WXMSW__)
	int n = 0;
	int offset = 0;
...
int wxSerialCom::WriteDevice(char *serBuf, int endMark, bool bFile)
{
#if !defined(__WXMSW__)
	int n = 0;
	int offset = 0;
...
int wxSerialCom::ConfigureDevice()
{
	unsigned long baudR;
...
int wxSerialCom::Rselect(int fd, struct timeval *timeout)
{
#if !defined(__WXMSW__)
	fd_set readfds;
...
int wxSerialCom::Wselect(int fd, struct timeval *timeout)
{
#if !defined(__WXMSW__)
	fd_set writefds;
...
__u8 wxSerialCom::GetDataBit()
{
	return dataBit;
}

__u8 wxSerialCom::GetStopBit()
{
	return stopBit;
}

__u8 wxSerialCom::GetParityBit()
{
	return parityBit;
}

__u8 wxSerialCom::GetFlowControl()
{
	return flowControl;
}

__u64 wxSerialCom::GetBaudRate()
{
	return baudRate;
}

void wxSerialCom::SetDataBit(__u8 dataB)
{
	dataBit = dataB;
}

void wxSerialCom::SetParityBit(__u8 parityB)
{
	parityBit = parityB;
}

void wxSerialCom::SetStopBit(__u8 stopB)
{
	stopBit = stopB;
}

void wxSerialCom::SetFlowControl(__u8 flowC)
{
	flowControl = flowC;
}

void wxSerialCom::SetBaudRate(__u64 baudB)
{
	baudRate = baudB;
}

#ifdef __WXMSW__
HANDLE wxSerialCom::GetDevHandle()
{
	return h_Dev;
}

void wxSerialCom::SetHandle(Handle hnd)
{
	h_Dev = hnd;
}
#endif
int wxSerialCom::SetSerialSpeed(int fd, int speed)
{
#ifdef __WXMSW__
	BOOL fRetVal;
	DCB dcb;
...
int wxSerialCom::SetSerialDataBit(int fd, int databits)
{
#ifdef __WXMSW__
	BOOL fRetVal;
	DCB dcb;
...
int wxSerialCom::SetSerialParityBit(int fd, int paritybits)
{
#ifdef __WXMSW__
	BOOL fRetVal;
	DCB dcb;
...
int wxSerialCom::SetSerialStopBit(int fd, int stopbits)
{
#ifdef __WXMSW__
	BOOL fRetVal;
	DCB dcb;
...
int wxSerialCom::SetSerialFlowControl(int fd, int flowctl)
{
#ifdef __WXMSW__
	BOOL fRetVal;
	DCB dcb;
...
int wxSerialCom::SetSerialDTRRTS(int fd, bool rts, bool dtr)
{
#ifdef __WXMSW__
	BOOL fRetVal;
	DCB dcb;
...
int wxSerialCom::MapSpeed(int speed)
{
#if !defined(__WXMSW__)
	switch (speed) {
	case BAUD_4800:
...
int wxSerialCom::MapDataBit(int databits)
{
#if !defined(__WXMSW__)
	switch (databits) {
	case DATABIT_5:
...
int wxSerialCom::MapParityBit(int paritybits)
{
#ifdef __WXMSW__
	switch (paritybits) {
	case PAR_EVEN:
...
int wxSerialCom::MapStopBit(int stopbits)
{
#ifdef __WXMSW__
	switch (stopbits) {
	case STOP_1:
