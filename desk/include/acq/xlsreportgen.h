...
*/
#ifndef WXXLSREPORTGEN_H
#define WXXLSREPORTGEN_H
...
class wxXLSReportGen:public wxReportGen {
  public:
	wxXLSReportGen(char *reportFile = NULL, bool bOpen = false);
	 virtual ~ wxXLSReportGen() {
	};
