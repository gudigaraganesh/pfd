...
*/
#ifndef WXBLUETOOTHCOM_H
#define WXBLUETOOTHCOM_H
#include <stdio.h>
...
class wxBluetoothCom:public wxVirtualCom {
  public:
	wxBluetoothCom(char *virtDev = NULL, bool bOpen = false);
	// wxBluetoothCom (wxBluetoothCom & vCom);
	 virtual ~ wxBluetoothCom() {
	};
