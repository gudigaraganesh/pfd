 ...
 ***************************************************************************/
#ifndef WXMULTIPLEXDISP_H
#define WXMULTIPLEXDISP_H
/**
...
class wxMultiplexDisp:public wxPlotWindow {
  public:
	wxMultiplexDisp() {
	};
	wxMultiplexDisp(wxWindow * parent, wxWindowID id, const wxPoint & pos,
  ...
  private:
	...
	DECLARE_DYNAMIC_CLASS(wxMultiplexDisp)
		DECLARE_EVENT_TABLE()
};
