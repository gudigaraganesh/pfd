 ...
 ***************************************************************************/
#ifndef WXTABLEINFO_H
#define WXTABLEINFO_H
...
class wxTableInfo:public wxGrid {
  public:
	wxTableInfo() {
	};
	wxTableInfo(wxWindow * parent, wxWindowID id, const wxPoint & pos,
  ...
  private:
	...
	DECLARE_DYNAMIC_CLASS(wxTableInfo)
};
